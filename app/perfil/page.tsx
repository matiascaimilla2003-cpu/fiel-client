...
// ── EditProfileModal ──
function EditProfileModal({ onClose, initialName }: { onClose: () => void; initialName: string }) {
    ...
    >
      ...
      >
          ...
          <div>
            ...
            <div style={{
              ...
              <input value={name} onChange={e => setName(e.target.value)} placeholder="Tu nombre"
                style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontFamily: 'inherit', fontSize: 15, fontWeight: 500 }}/>
            </div>
          </div>
          {/* Teléfono */}
          <div>
            ...
            <div style={{
              ...
              <span style={{ color: '#8a8aa3', fontSize: 14, fontWeight: 500, marginRight: 10 }}>+56</span>
              <input value={phone} onChange={e => setPhone(e.target.value)} placeholder="9 0000 0000"
                style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontFamily: 'inherit', fontSize: 15, fontWeight: 500 }}/>
            </div>
          </div>
          {/* Email */}
          <div>
            <div style={{ fontSize: 10, letterSpacing: '0.18em', color: '#8a8aa3', fontWeight: 600, marginBottom: 6 }}>EMAIL</div>
            <div style={{
              display: 'flex', alignItems: 'center',
              background: '#0f0f1a', border: '1px solid rgba(255,255,255,0.06)',
              borderRadius: 12, padding: '0 14px', height: 50,
            }}>
              <input value={email} onChange={e => setEmail(e.target.value)} placeholder="tu@email.cl"
                style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontFamily: 'inherit', fontSize: 15, fontWeight: 500 }}/>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
          ...
          <button onClick={onClose}
            style={{
              flex: 1.4, background: '#fff', color: '#0a0a0a', border: 'none',
...
export default function PerfilPage() {
  ...
  const [modal, setModal]       = useState<'logout' | 'edit' | null>(null);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            background: 'rgba(99,102,241,0.10)', border1: '1px solid rgba(99,102,241,0.18)',
      ...
      <div style={{ padding: '12px 20px 100px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <MenuRow
            ...
            title="Editar perfil" sub="Nombre, teléfono, email"
            onClick={() => setModal('edit')}
          />
          <MenuRow
      ...
      <AnimatePresence>
        ...
        {modal === 'edit' && (
          <EditProfileModal key="edit" onClose={() => setModal(null)} initialName={u.nombre}/>
        )}
      </AnimatePresence>
    </div>
  );
